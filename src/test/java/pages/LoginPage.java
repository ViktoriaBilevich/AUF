...
// Инициализация класса
    public LoginPage(BrowsersService browsersService, boolean openPageByUrl) {super(browsersService, openPageByUrl);}
    ...
    public String getErrorText(){return driver.findElement(errorLabelBy).getText();}
